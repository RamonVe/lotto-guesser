...
def registration_window(root_window, login_window):
    ...
    label_0 = Label(register_window, text='Registration form', width=20, font=('bold', 20))
    ...
    label_1 = Label(register_window, text='FullName', width=20, font=('bold', 10))
    label_1.place(x=80, y=130)
    # this will accept the input string text from the user.
    entry_1 = Entry(register_window)
    entry_1.place(x=240, y=130)
    # this creates 'Label' widget for Email and uses place() method.
    label_3 = Label(register_window, text='Email', width=20, font=('bold', 10))
    label_3.place(x=68, y=180)
    entry_3 = Entry(register_window)
    entry_3.place(x=240, y=180)
    # this creates 'Label' widget for Gender and uses place() method.
    label_4 = Label(register_window, text='Gender', width=20, font=('bold', 10))
    ...
    Radiobutton(register_window, text='Male', padx=5, variable=var, value=1).place(x=235, y=230)
    Radiobutton(register_window, text='Female', padx=20, variable=var, value=2).place(x=290, y=230)
    # this creates 'Label' widget for country and uses place() method.
    label_5 = Label(register_window, text='Country', width=20, font=('bold', 10))
    ...
    c = StringVar()
    droplist = OptionMenu(register_window, c, *list_of_country)
    droplist.config(width=15)
    c.set('Select your Country')
    droplist.place(x=240, y=280)
    # this creates 'Label' widget for Language and uses place() method.
    label_6 = Label(register_window, text='Language', width=20, font=('bold', 10))
    ...
    Checkbutton(register_window, text='English', variable=var1).place(x=230, y=330)
    # the variable 'var2' mentioned here holds Integer Value, by default 0
    var2 = IntVar()
    Checkbutton(register_window, text='German', variable=var2).place(x=290, y=330)
    # this creates button for submitting the details provides by the user
    Button(register_window, text='Submit', width=20, bg='black', fg='white').place(x=180, y=380)
