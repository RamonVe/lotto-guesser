...
def registration_window(root_window, login_window):
    ...
    f_name_entry = Entry(register_window)
    l_name_entry = Entry(register_window)
    age_entry = Entry(register_window)
    location_entry = Entry(register_window)
    user_name_entry = Entry(register_window)
    pass_word_entry = Entry(register_window)
    ...
    Button(register_window, text='Submit', width=16, bg='black', fg='white').grid(row=6, column=1)
